...
If you're looking to migrate your native UI components to the new architecture (Fabric), check out our [Native Components Migration Guide for Android](/docs/migration/native-components-migration-android). It provides step-by-step instructions for migrating existing components.
:::
