...
If you're looking to migrate your native UI components to the new architecture (Fabric), check out our [Native Components Migration Guide for iOS](/docs/migration/native-components-migration-ios). It provides step-by-step instructions for migrating existing components.
:::
